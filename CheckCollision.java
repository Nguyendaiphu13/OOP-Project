    ...
    public static void bounceOff(Ball ball, GameObject other) {
        if (other instanceof Brick) {
            ...
            if (overlapX < overlapY) {
                ...
                -> Ta đặt lại vị trí của bóng ngay sát bên trái viên gạch.
                Ngược lại (bóng đang đi sang trái), nó đã va vào cạnh phải của gạch
                -> Ta đặt lại vị trí của bóng ngay sát bên phải viên gạch.
                 */
                ball.setX(ball.dx > 0 ? other.getX() - ball.getWidth() : other.getX() + other.getWidth());
            } else {
                // chạm mặt trên và dưới
                ball.directionY *= -1;
                // chống dính gạch
                ball.setY(ball.dy > 0 ? other.getY() - ball.getHeight() : other.getY() + other.getHeight());
            }
