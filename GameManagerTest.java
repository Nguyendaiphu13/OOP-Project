...
import org.mockito.Spy; // <-- 1. THÊM IMPORT SPY
...
class GameManagerTest {
    ...
    @BeforeEach
    void setUp() {
        // KHÔNG CẦN "new GameManager()" nữa, vì @Spy đã làm
        ...
        // 3. XÓA BỎ GẠCH DUMMY, không cần nữa
        // gameManager.bricks.add(new Brick(9999, 9999, 1, 1, "dummy"));

        // 4. ĐÂY LÀ PHÉP THUẬT:
        // Bảo Mockito: "Bất cứ khi nào hàm setupGameObjects() được gọi,
        // HÃY KHÔNG LÀM GÌ CẢ (doNothing)"
        // Điều này ngăn nó tải ảnh và gây crash.
    ...
    void testBrickCollision_NormalBrick_And_Scoring() {
        ...
        // Act
        gameManager.updateGame(mockSoundManager);
        // -> Bên trong hàm này, setupGameObjects() SẼ BỊ GỌI,
        //    nhưng Mockito sẽ chặn nó lại (doNothing),
        //    ngăn chặn crash.
